 ...
 *
 * @RestResource(
 * id = "artical_node_rest_resource",
 * label = @Translation("artical node rest resource"),
 * serialization_class = "Drupal\node\Entity\Node",
 * uri_paths = {
 * "canonical" = "/api/custom-node-rest.json",
 * "https://www.drupal.org/link-relations/create" = "/api/artical-node-rest"
 * }
 * )
 */
class ArticalNodeRestResource extends ResourceBase {
